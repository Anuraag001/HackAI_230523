"""
Django settings for currency_alert project.
...
SECRET_KEY = 'django-insecure-hhjd4v)6(sd&ibpzc#jihyvd&qdabhf+u)5)b$%n-j$05cror-'
...
ROOT_URLCONF = 'currency_alert.urls'
...
WSGI_APPLICATION = 'currency_alert.wsgi.application'
